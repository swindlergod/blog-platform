...
export default function Header() {
    ...
    return (
        <div className="header">
            <Link to='/articles' className="header__logo">Realworld blog</Link>
            {!isLoggedIn &&
            <>               
            ...
            {isLoggedIn &&
            <>               
                <Link to='' className="header__article">Create article</Link>
                <Link to="/profile" className="header__user">
                    <p className="user__nickname header__nickname">{username}</p>
                    <img className='info__avatar' src={image} alt="" />
                </Link>
                <Link to='/' className="header__logout" onClick={logout}>Log out</Link>
            </>            
            }
        </div>
    )
